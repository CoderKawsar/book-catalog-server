...
const createBook = (bookData) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield book_model_1.Book.create(Object.assign({}, bookData));
    return result;
});
const getAllBooks = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield book_model_1.Book.find({}).sort({ createdAt: -1 });
    return result;
});
const getAllFilteredBooks = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield book_model_1.Book.find(whereConditions)
        ...
        .skip(skip)
        .limit(limit);
    const total = yield book_model_1.Book.find(whereConditions)
        .sort(sortConditions)
        .countDocuments();
    return {
        meta: {
